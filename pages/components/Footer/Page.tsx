...
const Footer = () => {
  return (
    <div>
      <footer className="py-8 md:py-12 px-4 md:px-8 bg-black
       text-secondary-foreground border-t border-border">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div data-aos= "fade-up" className=" text-center sm:text-left">
          ...
          <ul className="space-y-2 text-muted-foreground text-center sm:text-left ">
        ...
        <div data-aos= "fade-up" className="text-center sm:text-left">
          ...
          <ul className="space-y-2 text-muted-foreground">
            ...
            <li className="hover:text-foreground transition-colors">SEO</li>
            <li className="hover:text-foreground transition-colors">UI/UX Design</li>
            <li className="hover:text-foreground transition-colors">Financial Consultancy</li>
          </ul>
        </div>
        ...
        <div data-aos= "fade-up" className="text-center sm:text-left">
          ...
          <ul className="space-y-2 text-muted-foreground">
            <li className="hover:text-foreground transition-colors">Our Story</li>
            <li className="hover:text-foreground transition-colors">Team</li>
            <li className="hover:text-foreground transition-colors">Careers</li>
          </ul>
        </div>
      </div>
